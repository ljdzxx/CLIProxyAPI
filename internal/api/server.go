...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.POST("/auth-files/refresh-token", s.mgmt.RefreshAuthFileToken)
		mgmt.POST("/auth-files/refresh-token/all", s.mgmt.StartRefreshAllAuthFileTokens)
		mgmt.GET("/auth-files/refresh-token/jobs/:id", s.mgmt.GetRefreshAuthFileTokenJob)
		...
		mgmt.POST("/codex-auth-url", s.mgmt.PostCodexToken)
